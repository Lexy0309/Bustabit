define([
    ...
    var _cashOutChk = Clib.localOrDef('cashOutChk', false);
    ...
    var ControlsStore = _.extend({}, Events, {
        ...
        _setAutoCashOutChk: function(autoCashOutChk) {
            _cashOutChk = autoCashOutChk;
            localStorage['cashOutChk'] = _cashOutChk;
        },
    ...
    AppDispatcher.register(function(payload) {
        ...
        switch(action.actionType) {
            ...
            case AppConstants.ActionTypes.SET_AUTO_CASH_OUT_CHK:
                ControlsStore._setAutoCashOutChk(action.autoCashOutChk);
                ControlsStore.emitChange();
                break;
