define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            MAX_BET: 300000 /** Max bet per game 3,000,000 Bits, this will be calculated dynamically in the future, based on the invested amount in the casino **/
        },
