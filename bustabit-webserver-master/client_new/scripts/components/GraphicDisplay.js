...
define([
    ...
    Graph.prototype.drawGameData = function() {
        ...
        if(Engine.gameState === 'ENDED') {
			//modify by lt fontsizePx(15), fontsizenum(15)
            this.ctx.font = fontSizePx(10) + " Verdana";
            this.ctx.fillStyle = "red";
            this.ctx.fillText('게임결과', this.canvasWidth/2, this.canvasHeight/2 - fontSizeNum(10)/2);
            this.ctx.fillText('@ ' + Clib.formatDecimals(Engine.tableHistory[0].game_crash/100, 2) + 'x', this.canvasWidth/2, this.canvasHeight/2 + fontSizeNum(10)/2);
        }
        ...
        if(Engine.gameState === 'STARTING') {
            ...
            this.ctx.fillText('다음 게임 시작 '+timeLeft+'초전', this.canvasWidth/2, this.canvasHeight/2);
        }
